...
data <- data.frame(
  ...
  Metric = c("BM_Par_VaR", "BM_Par_ES", "POT_Par_VaR", "POT_Par_ES", 
             "BM_Par_VaR", "BM_Par_ES", "POT_Par_VaR", "POT_Par_ES"),
  Value = c(0.049, -0.871, -2.163, -2.932, 
            0.402, -0.483, -3.963, -5.163)
)
...
ggplot(data, aes(x = Confidence_Level, y = Value, fill = Metric)) +
  ...
  scale_fill_manual(values = c(
    "BM_Par_VaR" = "deepskyblue",
    "BM_Par_ES" = "forestgreen",
    "POT_Par_VaR" = "seagreen3",
    "POT_Par_ES" = "cyan3"
  )) +
  theme_minimal() +
