...
Hence, in order to circumvent this problem, it is possible to use the following two-step approach:
...
ggplot() +
  geom_point(data = yearly_max, aes(x = Year, y = MaxPrecipitation), color = "#1CADE4") +
  geom_smooth(data = yearly_max, aes(x = Year, y = MaxPrecipitation), method = "lm", color = "#27CED7", se = FALSE) +
